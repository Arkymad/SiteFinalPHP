<?php 
  ...
  $plano = $PrecoService->localizar($_GET['id']);
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form id="planoform" action="" method="post">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="idPreco" name="inputPreco" class="form-control" value="<?= $plano->getTitulo() ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="inputInfo2" name="inputInfo2" class="form-control" value="<?= $plano->getInfo1() ?>">
                </div>
                <div class="form-group">
                  <label for="inputInfo3">Descrição do Plano</label>
                  <input type="text" id="inputInfo3" name="inputInfo3" class="form-control" value="<?= $plano->getInfo1() ?>">
                </div>
                <div class="form-group">
                  <label for="inputInfo4">Descrição do Plano</label>
                  <input type="text" id="inputInfo4" name="inputInfo4" class="form-control" value="<?= $plano->getInfo1() ?>">
                </div>
                <div class="form-group">
                  <label for="inputInfo5">Descrição do Plano</label>
                  <input type="text" id="inputInfo5" name="inputInfo5" class="form-control" value="<?= $plano->getInfo1() ?>">
                </div>
                <div class="form-group">
                  <label for="inputInfo6">Descrição do Plano</label>
                  <input type="text" id="inputInfo6" name="inputInfo6" class="form-control" value="<?= $plano->getInfo1() ?>">
                </div>
                <div class="form-group">
                  <label for="inputInfo7">Descrição do Plano</label>
                  <input type="text" id="inputInfo7" name="inputInfo7" class="form-control" value="<?= $plano->getInfo1() ?>">
                </div>
                <div class="form-group">
                  <label for="inputInfo8">Descrição do Plano</label>
                  <input type="text" id="inputInfo8" name="inputInfo8" class="form-control" value="<?= $plano->getInfo1() ?>">
                </div>
              </form>
            </div>
            <!-- /.card-body -->
