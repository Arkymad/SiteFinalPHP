        ...
        <section class="page-section" id="planos">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Sistema de Gerenciamento de Planos</h2>
                    <h3 class="section-subheading text-muted">Utilize a tabela abaixo para editar ou excluir as informações sobre os planos.</h3>
                </div>
                <table class="table table-stripped" style="color: black;">
                    ...
                    <tbody>
                        <?php foreach($_SESSION['planos_lista'] as $plano) : ?>
                        <tr>
                            <td><?= $plano->id ?></td>
                            <td><?= $plano->tipo ?></td>
                            <td><?= $plano->preco ?></td>
                            <td><?= $plano->info1 ?></td>
                            <td>
                                <a href="planos.form.editar.php?id=<?= $plano->id ?>"><i class="bi bi-pencil-square"></i></a>&nbsp;
                                <a onclick="return confirm('Deseja realmente remover este item?')" href="planos.deletar.php?id=<?= $plano->id ?>"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
